...
void I2C_SSD1306_Screen_Init(I2C_HandleTypeDef *hi2c1) {
  ...
  // (https://www.alldatasheet.com/datasheet-pdf/view/1179026/ETC2/SSD1306.html)
...
void I2C_SSD1306_Update_Whole_Display(
  ...
  uint8_t command_data[12] = {0x80, 0x21, 0x80, 0x0,  0x80, 127,
                              0x80, 0x22, 0x80, 0x00, 0x80, 0x07};

  // Create an array to hold the data to send to the display + 1 (byte to
  // indicate data transmission, which is 0x40)
  uint8_t data[1025] = {0};
  data[0] = 0x40;
